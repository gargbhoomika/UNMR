...
namespace UNMR.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        public static List<ApplicationLanguage> InitialLanguages => GetInitialLanguages();

        private readonly UNMRDbContext _context;

        private static List<ApplicationLanguage> GetInitialLanguages()
        {
            var tenantId = UNMRConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
        ...
        public DefaultLanguagesCreator(UNMRDbContext context)
        {
            _context = context;
        }
