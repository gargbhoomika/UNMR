...
{
    public abstract class UNMRWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static UNMRWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(UNMRWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<UNMRDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<UNMRDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<UNMRDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<UNMRDbContext, Task<T>> func)
        {
            T result;
